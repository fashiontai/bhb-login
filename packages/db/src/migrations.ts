...
const personalIntroductionMigrationSql = `CREATE TABLE IF NOT EXISTS personal_introduction (
    id TEXT PRIMARY KEY,
...
const performanceEventsMigrationSql = `CREATE TABLE IF NOT EXISTS performance_event (
    id TEXT PRIMARY KEY,
...
const migrations = [
	...
	{
		name: "20260724120000_personal_introduction",
		sql: personalIntroductionMigrationSql,
	},
	{
		name: "20260805090000_performance_events",
		sql: performanceEventsMigrationSql,
	},
];
